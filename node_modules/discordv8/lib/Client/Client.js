...
class Client extends _events2.default {
  ...
  */
	destroy(callback = () => /*err, {}*/{}) {
		return this.internal.logout().then(() => this.internal.disconnected(true)).then(dataCallback(callback), errorCallback(callback));
	}
  ...
  */
	...
	awaitResponse(msg, toSend = null, options = null, callback = () => /*err, newMsg*/{}) {
		...
		// (msg) promise
		return ret.then(() => this.internal.awaitResponse(msg)).then(dataCallback(callback), errorCallback(callback));
	}
