...
const API = exports.API = Constants.API = "https://discordapp.com/api";
const CDN = exports.CDN = Constants.CDN = "https://cdn.discordapp.com";

const Endpoints = exports.Endpoints = Constants.Endpoints = {
	// general endpoints
...
const Permissions = exports.Permissions = Constants.Permissions = {
	// general
...
const PacketType = exports.PacketType = Constants.PacketType = {
